...
export const WONDER_DEFS = {
  ...
  machu_picchu:     { key: 'machu_picchu', name: 'Machu Picchu', era: 4, tech: 'Civil Service', footprint: [1, 1], placement: 'mountain', special: 'mountain_levels', effect: 'Units & buildings on mountains gain +2 free upgrade levels.' },
  ...
  great_mirror:     { key: 'great_mirror', name: 'Great Mirror', era: 14, tech: 'Solar Reflection', footprint: [1, 1], placement: 'land', special: 'terrestrial_levels', effect: 'All terrestrial units & buildings +2 upgrade levels.' },
  ...
  happy_valley:     { key: 'happy_valley', name: 'Happy Valley', era: 16, tech: 'Martianism', footprint: [1, 1], placement: 'mars', special: 'mars_levels', effect: 'Units & buildings on Mars gain +8 free upgrade levels.' },
