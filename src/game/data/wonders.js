...
export const WONDER_DEFS = {
  ...
  great_wall:       { key: 'great_wall', name: 'Great Wall', era: 3, tech: 'Great Wall', footprint: [4, 1], placement: 'land', special: 'multi_lane_wall', hp: 20, effect: 'One shared-HP blocker spanning 4 lanes (:defense: 20). Units on it are attacked only after it falls.' },
