...
export const BUILDING_DEFS = {
  ...
  caltrops: {
    ...
    special: 'trap_cross_dmg', trapTrigger: 'cross', trapDamage: 20,
  ...
  decoy: {
    ...
    special: 'trap_bait', trapTrigger: 'bait',
  ...
  powder_magazine: {
    ...
    special: 'trap_death_dmg', trapTrigger: 'death', trapDamage: 45,
  ...
  discombobulator: {
    ...
    special: 'trap_skip_turn', trapTrigger: 'skip', trapCooldown: 5,
  ...
  singularity: {
    ...
    special: 'trap_impassable', trapTrigger: 'impassable', trapDamage: 1000,
  ...
  command_post: {
    ...
    hp: 2, upHp: 0, upgradeTarget: 'range', range: 1,
    special: 'command_atk', commandAtk: 0.5,
  ...
  star_fort: {
    ...
    types: ['command'], placement: 'land',
    hp: 2, upHp: 0, upgradeTarget: 'range', range: 1,
    special: 'command_range', commandRange: 1,
  ...
  radio_tower: {
    ...
    special: 'command_range', commandRange: 2,
  ...
  deflector_array: {
    ...
    types: ['command'], placement: 'land',
    hp: 2, upHp: 0, upgradeTarget: 'range', range: 1,
    special: 'command_def', commandDef: 2,
  ...
  psy_link: {
    ...
    special: 'command_atk', commandAtk: 1.0,
  ...
  national_park: {
    ...
    types: ['support'], placement: 'land',
    hp: 3, upHp: 0, upgradeTarget: 'output',
    special: 'stacks', parkYieldPct: 0.1,
    effect: 'Each National Park grants +10% (×level) to base terrain yields globally.',
  },
  carbon_sink: {
    ...
    hp: 3, upHp: 0, upgradeTarget: 'output',
    special: 'growth',
    effect: 'At the end of combat, terrestrial tiles gain +1 (×level) natural yield bonus (permanent, stacking).',
  },
  artificial_island: {
    key: 'artificial_island', name: 'Artificial Island', era: 16, tech: 'Industrial Desalination',
    types: ['support'], placement: 'coast',
    hp: 3, upHp: 0, upgradeTarget: 'none', noUpgrade: true,
    special: 'convert_tile', convertFrom: 'ocean', convertTo: 'island',
  ...
  asteroid_foundry: {
    ...
    hp: 3, upHp: 0, upgradeTarget: 'none', noUpgrade: true,
    special: 'convert_tile', convertFrom: 'space', convertTo: 'asteroid',
  ...
  artificial_planet: {
    ...
    hp: 3, upHp: 0, upgradeTarget: 'none', noUpgrade: true,
    special: 'convert_tile', convertFrom: 'deep_space', convertTo: 'exoplains',
