...
export const IMPLEMENTED = {
  ...
  'Writing':      { kind: 'pop', key: 'scholar', description: 'Unlocks the Scholar specialist (+6 :progress: per tick).' },
  'Archery':      { kind: 'unit', key: 'archer', description: 'Unlocks the Archer — a land :ranged: unit.' },
  'Sailing':      { kind: 'unit', key: 'galley', description: 'Unlocks the Galley — a coastal :naval: unit that fights as :melee:.' },
  ...
  'Baking':       { kind: 'unit', key: 'baker', description: 'Unlocks the Baker — a :utility: unit that permanently toughens adjacent units when it acts.' },
  'Caste System': { kind: 'policy', key: 'caste_system', description: 'Unlocks the Caste System policy — upgraded units (level 2+) deal +25% :attack:.' },
  'Brothels':     { kind: 'building', key: 'brothel', description: 'Unlocks the Brothel — a :utility: building whose adjacent units attack faster and harder.' },
  'Masonry':      { kind: 'modifier', key: 'masonry', silhouette: '/sprites/ui/defense.png', description: 'Permanently gives all buildings +10 :defense:.' },
  'Trade Networks': { kind: 'policy', key: 'trade_networks', description: 'Unlocks the Trade Networks policy — each Citizen also produces +2 :gold: per tick.' },
  'Hospitality Rites': { kind: 'policy', key: 'hospitality_rites', description: 'Unlocks the Hospitality Rites policy — hiring mercenaries costs 50% less :gold:.' },
