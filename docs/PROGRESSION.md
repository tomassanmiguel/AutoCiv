# Progression Tree — Advancement → Unlocks

Units/buildings/specialists/wonders unlock via a *tech* whose name differs from the item; policies & bonuses keep their own name. **Warrior** is default. Thresholds: reducer techs show their discount; base thresholds grow `T(N)=T(N-1)+X·1.25^E·n·R` (progress X=5.6, food X=13.3, production X=7.4). `[proposed]`.
...
| Advancement | | Unlocks |
|---|--|---|
| **Mining** | ✦ | Mining — reduce production threshold -5% |
| **Writing** | ✦ | Writing — reduce progress threshold -5% |
...
| Advancement | | Unlocks |
|---|--|---|
| **Calendar** | ✦ | Calendar — +5 ticks per era |
| **Hereditary Rule** | ✦ | Hereditary Rule — unlock 6th policy slot |
| **Irrigation** | ✦ | Irrigation — reduce food threshold -6% |
| **Mathematics** | ✦ | Mathematics — +2 free builds on unlock |
| **Steel** | ✦ | Steel — units +15% atk |
...
| **Specialization** | 📜 | Specialization — +1 output to every specialist |
| **Weights and Measures** | 📜 | Weights and Measures — +1 gold per Citizen |
...
| Advancement | | Unlocks |
|---|--|---|
| **Cement** | ✦ | Cement — buildings +1 def |
| **Philosophy** | ✦ | Philosophy — reduce progress threshold -6% |
| **Arches** | 🏛 | Aqueduct — 6 food/t |
| **Celestial Navigation** | 🏛 | Lighthouse — 12 gold/t, +1 naval range |
| **Entertainment** | 🏛 | Arena — End-of-era gold from deployed units |
| **Organized Religion** | 🏛 | Temple — +20 legit, end-era gold |
| **Surveying** | 🏛 | Roads — Underlaid: links adjacency network |
...
| **Professional Soldiers** | 👤 | Soldier — units +1 attack each |
| **War Elephants** | 🗡 | War Elephant — Auxiliary; pushes enemy, pursues |
...
| **Metallurgy** | 🏛 | Forge — 8 production/t |
| **Bushido** | 📜 | Bushido — +50% atk to melee units |
| **Diplomatic Marriage** | 📜 | Diplomatic Marriage — +2 mercenary upgrade levels |
| **Festivals** | 📜 | Festivals — end-of-era effects +1 trigger |
| **Feudalism** | 📜 | Feudalism — +30% food, -20% progress |
...
| **Civil Service** | ⭐ | Machu Picchu — mountain units/buildings +2 upgrade levels |

### E5 · Late Medieval — 17

| Advancement | | Unlocks |
|---|--|---|
| **Branding** | ✦ | Metallurgy — reduce production threshold -6% |
| **Horseshoes** | 🏛 | Stables — Spawner: best Cavalry unit |
| **Stained Glass** | 🏛 | Glassworks — 8 production/t, +2 each era |
| **Strategy** | 🏛 | Command Post — Command: +50% atk aura |
| **Tithing** | 🏛 | Monastery — +30 legit, progress from legit |
| **Vassalage** | 🏛 | Decoy — Trap: enemies attack it first |
...
| Advancement | | Unlocks |
|---|--|---|
| **Clocks** | ✦ | Clocks — +6 ticks per era |
| **Engineering** | ✦ | Engineering — +2 free builds on unlock |
...
| **Canons** | 🗡 | Cannoneer — Ranged; atk 11 range 3 |
...
| Advancement | | Unlocks |
|---|--|---|
| **Combustion** | ✦ | Combustion — reposition bridging across ocean |
| **Industrial Agriculture** | ✦ | Industrial Agriculture — reduce food threshold -8% |
| **Railroad** | ✦ | Railroad — reduce production threshold -7% |
...
| **Artillery** | 🗡 | Mortar Squad — Ranged; atk 21 range 4 |
| **Flight** | 🗡 | Biplane — Aerial; flanking, atk 20 |
| **Tanks** | 🗡 | Tank — Cavalry; high defense 6 |
| **Total War** | 🗡 | Mustard Man — Auxiliary; applies poison |
...
| Advancement | | Unlocks |
|---|--|---|
| **Deflectors** | 🏛 | Deflector Array — Command: +2 def aura |
| **Adaptive Strategy** | 📜 | Adaptive Strategy — +5% atk per combat-turn |
| **Reinforced Construction** | 📜 | Reinforced Construction — buildings +2 def |
| **Artificial Gravity** | 🗡 | Hovercraft — Aerial; flies over water |
| **Gundam** | 🗡 | Leviathan — Naval; atk 37 range 4 |
| **Plasmatics** | 🗡 | Plasmer — Ranged; atk 43 range 4 |
| **Replicant Legions** | 🗡 | Terminator — Melee; atk 54 def 4 |
| **Combat Simulation** | ⭐ | The Ansible — +1 range to all ranged effects |
...
| Advancement | | Unlocks |
|---|--|---|
| **Matter Compression** | ✦ | Matter Compression — reduce production threshold -10% |
| **Tightbeams** | ✦ | Tightbeams — +1 ranged reach |
| **Alien Ecology** | 🏛 | Xenocultivator — 192 food/t |
| **Deep Space Construction** | 🏛 | Vacuum Assembly — 124 production/t |
| **Neocolonialism** | 📜 | Neocolonialism — exoplanet buildings +150% gold |
| **Perfect Trade** | 📜 | Perfect Trade — 30% end-of-era gold interest |
...
| Advancement | | Unlocks |
|---|--|---|
| **Liminism** | ✦ | Liminism — +8 ticks per era |
...
| **Adamantium** | 👤 | Nanomancer — +20 :production:/tick pop |
| **Neuropartitioning** | 👤 | Mentat — +16 :progress:/tick pop |
...
| Advancement | | Unlocks |
|---|--|---|
| **FTL** | ✦ | FTL — reposition bridging across deep space |
| **Shielding** | 🏛 | Shield Matrix — Wall: blocker, def 9 |
| **Vivification** | 🏛 | Tleilaxu Tanks — End-of-era +225 population |
| **Galactic Legion** | 📜 | Galactic Legion — produced unit copied onto adjacent tile |
| **Spaceflight Tactics** | 📜 | Spaceflight Tactics — +50% atk to astral units |
| **Universal Currency** | 👤 | Plutarch — +36 :gold:/tick pop |
| **Inertia Dampeners** | 🗡 | X-Wing — Aerial; space-capable |
| **Kyber Crystals** | 🗡 | Jedi — Melee; Force Push (5-turn cd) |
| **Particle Lance** | 🗡 | Tachyon Lancer — Ranged; hits enemies in line |

### E24 · Late Galactic — 13

| Advancement | | Unlocks |
|---|--|---|
| **Antimatter** | ✦ | Antimatter — units +60% atk |
| **Hyperquantum Computing** | ✦ | Hyperquantum Computing — reduce progress threshold -14% |
| **Megastructure Engineering** | ✦ | Megastructure Engineering — wonder cost -2 builds |
| **Nanoswarms** | ✦ | Nanoswarms — reduce production threshold -12% |
| **Gene Splicing** | 🏛 | Cloning Bay — 446 food/t |
| **Kardashev Advancement** | 🏛 | Dyson Sphere — 548 production/t |
| **Planetogenesis** | 🏛 | Artificial Planet — Converts deep-space tile to land |
| **Singularity Stations** | 🏛 | Black Hole Station — 673 progress/t |
| **Empire of the Stars** | 📜 | Empire of the Stars — space buildings +4 levels |
| **Omniplomacy** | 📜 | Omniplomacy — +6 mercenary upgrade levels |
| **Adaptive Hulls** | 🗡 | Star Destroyer — Astral; tanky stationary ranged |
